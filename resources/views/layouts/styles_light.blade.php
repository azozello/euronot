...
<link href="{{ asset('js/plugins/magnificPopup/dist/magnific-popup.css') }} " rel="stylesheet"/>
...
<script src="{{ asset('js/plugins/magnificPopup/dist/jquery.magnific-popup.js') }}"></script>
