			...
			<div class="right" id="cont_right">
				...
				<div class="last_lev row" id="contact_form">
					<div class="col-md-6 col-xs-12" style="text-align: right;">
						...
						<input type="text" name="phone" class="req" maxlength="255" placeholder="Номер телефона"
						       title="Номер телефона"/>
					</div>
					<div class="col-md-6 col-xs-12">
						<textarea name="comment" class="req" cols="" rows="" placeholder="Сообщение" title="Сообщение"
