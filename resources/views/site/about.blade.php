	...
	<div class="container">
		<div id="breadcrumbs" class="hidden-sm-down">
			<span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/" itemprop="url"><span
					itemprop="title">Компьютерная техника бу</span></a>&nbsp;&nbsp;>&nbsp;&nbsp;<span>О компании</span></span>
		</div>
		<h1 class="page_title ">О компании</h1>
		<div class="page_text"><p style="text-align: justify;"><img
				style="float: left; margin-left: 10px; margin-right: 10px;" src="../index_app/upload/image/demonstratsija.png"
				alt="" width="250"/>Интернет-магазин <strong>Evronot.com.ua</strong> специализируется на продаже
		                            компьютерной б/у техники из Европы. За <strong>5 лет нашей работы</strong> мы
		                            зарекомендовали себя как компания, целью которой является максимальная
		                            удовлетворенность клиентов &mdash; как розничных покупателей, так и организаций.</p>
			<p style="text-align: justify;">Мы предоставляем Вам возможность выбрать <strong>постлизинговую</strong> и
				<strong>корпоративную</strong> компьютерную технику из Европы <strong>по разумной цене</strong>.</p>
			<p style="text-align: justify;">Также Вы имеете возможность самостоятельно принять взвешенное решение о
			                                покупке того или иного товара благодаря максимально развернутому описанию
			                                товаров в нашем интернет магазине. Мы всегда поможем подобрать технику,
			                                максимально подходящею под Ваши цели и задачи. В телефонном режиме или
			                                непосредственно в магазине наши продавцы и консультанты готовы оказать Вам
			                                квалифицированную техническую консультацию и ответить на любые вопросы.</p>
			<p style="text-align: justify;">Все товары продаются с доставкой по Украине, которая осуществляется без
			                                предоплаты. В этом случае Вы получите свой заказ уже на следующий день.
			                                Также Вы имеете возможность получить свою покупку непосредственно в магазине
			                                по адресу: <strong>г. Киев, Московский проспект, 16 Б</strong> или
			                                воспользоваться услугами курьера по Киеву.</p>
			<p><img style="float: right; margin-left: 10px; margin-right: 10px;" src="../index_app/upload/image/zashchita_prav.png"
			        alt="" width="200" height="200"/></p>
			<div><span style="text-align: justify;"><br/></span></div>
			<div style="text-align: justify;"><span style="text-align: justify;">Есть возможность оплатить свой заказ несколькими способами. Мы принимаем: наличную оплату, безналичный перевод, а также оплату банковскими картами.&nbsp;</span>Также
			                                                                                                                                                                                                                                     мы
			                                                                                                                                                                                                                                     предоставляем
			                                                                                                                                                                                                                                     гарантию
			                                                                                                                                                                                                                                     на
			...
			<p style="text-align: justify;"><span class="f">&nbsp;</span><span
					class="ft"><br/>В соответствии с&nbsp;<span>Законом Украины&nbsp;</span>&laquo;О защите прав потребителей&raquo;</span>,
			                                                                                                                               Вы
			                                                                                                                               вседа
			                                                                                                                               имеете
			                                                                                                                               возможность
