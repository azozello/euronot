								...
								<div class="rating">
									<script type="text/javascript">
                                        ...
                                        function change_price_s() {
                                            ...
                                            added_price = added_price - ((added_price / 100) * skidka);

                                            document.getElementById('cena_s').innerText = added_price;
                                            document.getElementById('result_price').value = added_price;
                                        }
						...
						<div class="haract-block">
							@if(!is_null($proc))
								...
								<p class="hidden_text_pr">{{$product[0]->proc}}</p>
										...
										@if(!is_null($skidka))
											<select id="select_proc" onchange="change_price_s()">
												@else
							...
							@if(!is_null($op_memory))
								...
								<p class="hidden_text_pr">{{$product[0]->op_memory}}</p>
										...
										@if(!is_null($skidka))
											<select id="select_memory" onchange="change_price_s()">
												@else
							...
							@if(!is_null($hard))
								...
								<p class="hidden_text_pr">{{$product[0]->hard_memory}}</p>
										...
										@if(!is_null($skidka))
											<select id="select_hard" onchange="change_price_s()">
												@else
