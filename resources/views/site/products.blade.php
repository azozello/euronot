<!DOCTYPE html><html lang="ru"><head>
    ...
    <meta name="description" content="Системный блок Dell Precision T3500, характеристики: Intel Xeon X5660 / 2.8GHz / 4Гб / 500GB"/>
    <meta name="keywords" content="Системный блок Dell Precision T3500, цена, Dell Precision T3500 в Киеве, Dell Precision T3500 бу, Системные блоки Dell."/>
    ...
    <div class="container">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $("#buy_block .quant_down").click(function(){
                    ...
                    if(inp_val!=0&&inp_val!=null){$(this).parent().find('input').val(--inp_val);}
                })
                $("#buy_block .quant_up").click(function(){
                    var inp_val = parseInt($(this).parent().find('input').val());
                    if(inp_val==null){$(this).parent().find('input').val(1);}
                    else{$(this).parent().find('input').val(++inp_val);}
                })
        ...
        <div id="products_in" itemscope itemtype="http://schema.org/Product">
            <div id="breadcrumbs" class="hidden-sm-down">
                <span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/" itemprop="url"><span itemprop="title">Компьютерная техника бу</span></a>&nbsp;&nbsp;>&nbsp;&nbsp;<span itemprop="child" itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/products_cat-sistemnie_bloki.html" class="last" itemprop="url"><span itemprop="title">Системные блоки б/у</span></a></span></span>
            </div>    <div class="clear"></div>
            <div class="row">
                <div class="col-lg-6 pict-block">
                    <div id="pict_box" class="pict" href="images/pictures/products/20170524153523553.jpg" data-fancybox-group="gallery" title="">
                        <div class="varanty">
                            <img src="/images/varanty-12.png" title="гарантия" alt="гарантия"/>
                        </div>
                        <img alt="" title="" src="images/pictures/products/20170524153523553.jpg"/>

                    </div>
                    <div id="pict_line">
                        <div class="block pict" href="images/pictures/products/20170524153518713.jpg" data-fancybox-group="gallery" title="">
                            <div class="in_block">
                                <img alt="" title="" src="images/pictures/products/20170524153518713.jpg"/>
                            </div>
                        </div>
                        <div class="block pict" href="images/pictures/products/20170524153529266.jpg" data-fancybox-group="gallery" title="">
                            <div class="in_block">
                                <img alt="" title="" src="images/pictures/products/20170524153529266.jpg"/>
                            </div>
                        </div>
                        <div class="clear"></div>
                    </div>
     ...
     <div class="clear"></div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row prod-block-2">
                        <div class="col-lg-6 block-left">
                            <div class="avail">В наличии</div>                <div class="rating_block">
                                                    ...
                                                    $("#"+hide_id+" .rate .star5").hover(
                                                        function() {
                                                            ...
                                                            $.each(fields, function(index) {
                                                                if($(this).attr("id") < str){$(this).addClass(" active");}
                    ...
                    <div class="buy_line" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                        ...
                        <div class="buy_button_block">
                            ...
                            <div id="rassrochka"><img src="/images/privat.png" alt="privatbank"/>Доступна <u>«Оплата частями»</u></div>
                            <div id="kredit">


                                <a href="javascript:void(0)" class="" type="button" onclick="if (typeof(kreditmarket_popup_win)!='undefined') kreditmarket_popup_win.close(); kreditmarket_popup_win=window.open('https://agents.kreditmarket.ua/partners/_general/v01/?uid=napm2454576505379&product_id=263&product_name=%D0%A1%D0%B8%D1%81%D1%82%D0%B5%D0%BC%D0%BD%D1%8B%D0%B9+%D0%B1%D0%BB%D0%BE%D0%BA+Dell+Precision+T3500&product_price=8400&product_url=https%3A%2F%2Fwww.evronot.com.ua%2Fproducts-263.html', 'gener','width=780,height=360,top='+((screen.height-360)/2)+',left='+((screen.width-780)/2)+',toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no'); ga('send', 'event', 'Forma1', 'Podtverdit');" style="margin: 5px 50px 0px 0px; text-decoration: inherit;">Выбрать кредит или рассрочку</a>
                            </div>
                        ...
                        <div class="block-metki clear row">
                            <div class="col-sm-3 col-xs-6">
                                <img src="/images/gal_1.png"/>
                                <div class="text">Тест от
                                    независимого
                                    сервис-центра
                                    лизингодержателя</div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <img src="/images/gal_2.png"/>
                                <div class="text">
                                    Тест от
                                    производителя
                                    на всю технику
                    ...
                    <div class="bl_blocks">
                        <div class="blocks text_block bl_1 active" id="tab_1_block" itemprop="description">
                            <div class="col-lg-6">
                                <table border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <td width="433">
                                            <p><span>Intel &nbsp;Xeon W3530, 2,8 (MHz), 6 ядер, кеш память: 12 Mb.</span></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="193">
                            ...
                            <div class="col-lg-6">
                                ...
                                <p>&nbsp;</p>
                                <p>Подробную конфигурацию уточняйте у менеджера. Характеристики могут отличаться от представленных на сайте.</p>							</div>
                            <div class="clear"></div>
                        </div>
                        <div class="blocks text_block bl_2" id="tab_2_block">
                            <p>Варианты доставки:</p>
                            <ul>
                                <li><span style="font-family: 'arial black', 'avant garde';"><strong>Самовывоз</strong></span></li>
                            </ul>
                            <p><span style="font-family: arial, helvetica, sans-serif;">Самовывоз производится из магазина нашей сети, по адресу: г.Киев, Московский проспект16а (при предварительном согласовании с менеджером).&nbsp;</span></p>
                            <ul>
                                <li><span style="font-family: 'arial black', 'avant garde';"><strong>Доставка курьером</strong></span></li>
                            </ul>
                            <p><span style="font-family: arial, helvetica, sans-serif;">Доставка осуществляется только по г. Киев. Стоимость доставки 100 грн.</span></p>
                            <ul>
                                <li><span style="font-family: 'arial black', 'avant garde';"><strong>Доставка по Украине</strong></span></li>
                            </ul>
                            <p><span style="font-family: arial, helvetica, sans-serif;">Доставка осуществляется&nbsp;транспортной компанией "<a href="http://novaposhta.ua/" target="_blank">Новая почта</a>".</span></p>                            <div class="clear"></div>
                        </div>
                        <div class="blocks bl_3" id="tab_3_block">
                            <script type="text/javascript">
                                $(document).ready(function(){
                                    $(".add_block :input").keyup(function(){check_fill(".add_block");})
                                    $(".add_block :input").focusout(function(){check_fill(".add_block");})
                                ...
                                function sender(obj_id){
                                    ...
                                    text=text.trim();
                                    if(text==''){$("."+obj+".bl"+obj_id+" textarea").addClass("not_fill");return_value = false;}
                                    if(return_value==true){
                                        ...
                                        $.ajax({
                                            ...
                                            dataType: 'text',
                                            cache: false,
                                            data: {ev:"comment_add", text:text, type:'products', obj:'263', answ:obj_id},
                                            beforeSend: function(){$("."+obj+".bl"+obj_id+' .send').hide();},
                                            success: function(res) {
                                    ...
                                    <div class="main">
                                        ...
                                        <div class="row comments-row">
                                            <div class="col-md-6 col-xs-12">
                                                <input type="text" class="req" name="name" title="Имя" placeholder="Имя" value=""/><br/>
                                            </div>
                                            <div class="col-md-6 col-xs-12">
                                                <input type="text" class="req" name="email" title="E-mail" placeholder="E-mail" value=""/>
                                            </div>
                                            <div class="col-xs-12">
                                                <textarea title="Ваш комментарий" placeholder="Ваш комментарий" class="req"></textarea>
                                            </div>
                                            <div class="col-xs-12">
        ...
        </div><div class="clear"></div>  <div id="wrap_out" class="row">
