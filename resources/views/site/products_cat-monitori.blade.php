...
<head>
	...
	<meta name="description"
	      content="Бу мониторы из Европы от лучших производителей. Доставка по всей Украине без предоплаты. Обзор в Evronot."/>
		...
		<script type="text/javascript">
			$(document).ready(function () {
				$("#type_ch").change(function () {
					if ($(this).val() != 0) {
						location.replace("/products_cat-monitori-az" + $(this).val() + ".html");
					}
					else {
						location.replace("/products_cat-monitori.html");
					}
				})
				...
				<div class="left_side col-lg-3 filter-block">
						...
						<div class="filter_list">
							...
							<div class="check_block"><span class="checkbox_label filter_btn"><span
									class="checkbox"></span><div><input name="br" type="checkbox"
							                                            value="2:23"/>Apple <span class="cnt">(1)</span></div></span>
							</div>
							<div class="check_block"><span class="checkbox_label filter_btn"><span
									class="checkbox"></span><div><input name="br" type="checkbox"
					...
					<div class="left_block filter">
						...
						<div class="filter_list">
							...
							<div class="check_block"><span class="checkbox_label filter_btn"><span
									class="checkbox"></span><div><input name="br" type="checkbox" value="3:44"/>23&quot;-24&quot; <span
									class="cnt">(1)</span></div></span></div>
						</div>
					</div>
					<div class="clear"></div>
					...
					<div class="hidden-md-down">
						<div id="breadcrumbs" class="hidden-sm-down">
							<span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/" itemprop="url"><span
									itemprop="title">Компьютерная техника бу</span></a>&nbsp;&nbsp;>&nbsp;&nbsp;<span>Мониторы б/у</span></span>
						</div>
					</div>
					...
					<div class="products_box products">
						...
						<div class="col-md-4 col-xs-6">
							<div class="product ">
								<div class="image">
									...
									<a href="products-304.html">
										...
										<img alt="Монитор NEC MyltiSync LCD2470WVX"
										     title="Монитор NEC MyltiSync LCD2470WVX"
										     src="images/pictures/products/20171108131759508.jpg"/>
									</a>
							...
							<div class="product product-hover">
								...
								<div class="line"></div>
								<div class="price">2'500 грн</div>
								<div class="title_dop">24&quot; 1920x1200 /1000:1 /400cd/m² / VGA, DVI, DisplayPort,
								                       USB
								</div>
							</div>
						</div>
						...
						<div class="col-md-4 col-xs-6">
							<div class="product ">
								<div class="image">
									...
									<a href="products-303.html">
										...
										<img alt="Монитор 22&quot; NEC MultiSync EA223WM"
										     title="Монитор 22&quot; NEC MultiSync EA223WM"
										     src="images/pictures/products/20171108124729245.jpg"/>
									</a>

								</div>
								<a href="products-303.html">
									<div class="name">Монитор 22&quot; NEC MultiSync EA223WM</div>
								</a>
								<div class="line"></div>
							...
							<div class="product product-hover">
								...
								<div class="line"></div>
								<div class="price">2'399 грн</div>
								<div class="title_dop">22&quot; (1680x1050) / 250cd/m² / VGA, DVI, DisplayPort, USB
								</div>
							</div>
						</div>
						...
						<div class="col-md-4 col-xs-6">
								...
								<div class="image">
									...
									<a href="products-302.html">
										...
										<img alt="Монитор Fujitsu B22W-7" title="Монитор Fujitsu B22W-7"
										     src="images/pictures/products/20171108120638103.jpg"/>
									</a>
							...
							<div class="product product-hover">
								...
								<div class="title_dop">22&quot; (1680x1050) / 1.000:1 / 250cd/m² / VGA, DVI,
								                       DisplayPort, USB
								</div>
							</div>
						</div>
						...
						<div class="col-md-4 col-xs-6">
							<div class="product ">
								<div class="image">
									...
									<a href="products-270.html">
										<img alt="Монитор Dell 2007 WFP" title="Монитор Dell 2007 WFP"
										     src="images/pictures/products/20170524154947316.jpg"/>
									</a>

								</div>
								<a href="products-270.html">
									<div class="name">Монитор Dell 2007 WFP</div>
								</a>
								<div class="line"></div>
							...
							<div class="product product-hover">
								...
								<div class="title_dop">20.1&quot; (1680x1050) / S-IPS / 800:1 / 300cd/m² / VGA, DVI,
								                       4xUSB 2.0, S-Video
								</div>
							</div>
						</div>
						...
						<div class="col-md-4 col-xs-6">
							<div class="product ">
								<div class="image">
									...
									<a href="products-163.html">
										<img alt="Монитор Dell 2001FP" title="Монитор Dell 2001FP"
										     src="images/pictures/products/20170524155657129.jpg"/>
									</a>

								</div>
								<a href="products-163.html">
									<div class="name">Монитор Dell 2001FP</div>
								</a>
								<div class="line"></div>
								<div class="price">1'900 грн</div>
							</div>
							<div class="product product-hover">
								...
								<div class="title_dop">20&quot; (1600x1200) / TFT / 400:1 / 250cd/m² / VGA, DVI, 4xUSB
								                       2.0, S-Video
								</div>
							</div>
						</div>
							...
							<div class="product ">
								<div class="image">
									...
									<a href="products-188.html">
										<img alt="Монитор Samsung 213T" title="Монитор Samsung 213T"
										     src="images/pictures/products/20170524160146347.jpg"/>
									</a>

								</div>
								<a href="products-188.html">
									<div class="name">Монитор Samsung 213T</div>
								</a>
								<div class="line"></div>
						...
						<div class="col-md-4 col-xs-6">
							<div class="product ">
								<div class="image">
									...
									<a href="products-189.html">
										<img alt="Монитор Apple A1082" title="Монитор Apple A1082"
										     src="images/pictures/products/20170524160412376.jpg"/>
									</a>

								</div>
								<a href="products-189.html">
									<div class="name">Монитор Apple A1082</div>
								</a>
								<div class="line"></div>
							...
							<div class="product product-hover">
								...
								<div class="title_dop">23&quot; (1680x1050) / IPS/ 500:1 / 250cd/m² / VGA, DVI, USB
								</div>
							</div>
						</div>
					</div>
...
<div class="footer container-fluid">
	<div class="container">
		<div class="tags">
			...
			<p>Компания &laquo;Евронот&raquo; предлагает качественные профессиональные мониторы. Техника ранее
			   находилась в аренде (лизинге) в крупных компаниях в Европе. Срок такой аренды как правило 2-4 года, что
			   не является критичным для монитора и не влияет на его работоспособность. Все мониторы тщательно
			   тестируются независимым центром в Европе, компанией дилером и после нашими инженерами в Украине.</p>
			<p>Мониторы в прекрасном состоянии, абсолютно работоспособные, без битых пикселей, пятен и полос. Тип
			   матрицы зависит от модели, однако вне зависимости от ваших потребностей нам есть что вам предложить:
			   S-IPS, TFT, PVA и IPS. Углы обзора составляют 170-178 градусов. В наличии модели с внешними и встроенными
			   блоками питания, различными интерфейсами подключения и наличием USB-хаб. Подставки позволяют регулировать
			   высоту, а также угол наклона и поворота монитора. При необходимости есть возможность крепления к стене. В
			   наличии модели с диагональю экрана от 20 до 22 сантиметров.</p>
			<p>Мы предлагаем мониторы всемирно известных производителей: <a title="Монитор Dell"
			                                                                href="products-270.html">Dell</a>, Samsung,
			   Lenovo. Сфера применения может быть абсолютно любой, учеба или работа, торговля, производство, графика и
			   обработка видео. В любом случае вы получаете надежное устройство европейского качества.</p>
			<p>Предоставляется гарантия на все мониторы. Срок гарантии составляет до <strong>2 лет</strong> в
			   зависимости от модели. Гарантийное обслуживание входит в стоимость, мы не требуем дополнительной платы.
			</p>
