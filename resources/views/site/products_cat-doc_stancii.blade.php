...
<head>
	...
	<title>Лазерные принтеры. Обзор Evronot.com.ua</title>
	<meta name="description"
	      content="Принтеры в интернет магазине компьютерной техники бизнес класса из Германии. Гарантия. Доставка. Evronot"/>
	<meta name="keywords"
	      content="Купить принтер Киев, Принтер с доставкой, принтер дешево купить, гарантия, доставка, качество"/>
		...
		<script type="text/javascript">
			$(document).ready(function () {
				$("#type_ch").change(function () {
					if ($(this).val() != 0) {
						location.replace("/products_cat-doc_stancii-az" + $(this).val() + ".html");
					}
					else {
						location.replace("/products_cat-doc_stancii.html");
					}
				})
					...
					<script type="text/javascript">
						$(document).ready(function () {
							$(".filter_btn").click(function () {
								...
								location.replace("/products_cat-doc_stancii" + link + ".html");
							})
						})
					</script>
					...
					<div class="hidden-md-down">
						<div id="breadcrumbs" class="hidden-sm-down">
							<span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/" itemprop="url"><span
									itemprop="title">Компьютерная техника бу</span></a>&nbsp;&nbsp;>&nbsp;&nbsp;<span>Принтеры (NEW)</span></span>
						</div>
					</div>
					<h1 class="page_title">Принтеры (NEW)</h1>
					<div class="clear"></div>
						...
						<div class="col-md-4 col-xs-6">
							<div class="product ">
								<div class="image">
									...
									<a href="products-286.html">
										<img alt="Принтер RICOH SP 213nw" title="Принтер RICOH SP 213nw"
										     src="images/pictures/products/20170524160531614.png"/>
									</a>

								</div>
								<a href="products-286.html">
									<div class="name">Принтер RICOH SP 213nw</div>
								</a>
								<div class="line"></div>
								<div class="price">2'700 грн</div>
							</div>
							<div class="product product-hover">
								...
								<div class="rating_block">
									<div class="rating">
										<div class="star_box not_rated" id="star_box286">
											<div class="rate_hide">
								...
								<div class="title_dop">1200 x 600 dpi/PCL/150 листов/A4, B5(ISO), A5, B6, A6 Legal,
								                       Letter, Half Letter, Executive, 16K
								</div>
							</div>
						</div>
					</div>
