...
<head>
	...
	<title>Док станции для ноутбуков. Evronot.com.ua</title>
	<meta name="description"
	      content="Док станции в интернет магазине Евронот. Качественная техника. Гарантия на весь ассортимент. Быстрая доставка по Украине."/>
	<meta name="keywords"
	      content="Док станции в Киеве, док станции на Петровке, недорого, быстрая доставка, гарантия, купить, кредит."/>
	...
	<div class="container">
		...
		<div class="top-row row hidden-md-down">
			...
			<div class="address col-lg-1 col-md-1">
				<a class="adres" onclick='location.href="contact.html"' style="cursor: pointer">Адреса магазинов<br/>в
				                                                                                Украине</a>
		...
		<script type="text/javascript">
			$(document).ready(function () {
				$("#type_ch").change(function () {
					if ($(this).val() != 0) {
						location.replace("/products_cat-remont noutbukov-az" + $(this).val() + ".html");
					}
					else {
						location.replace("/products_cat-remont noutbukov.html");
					}
				})
					...
					<script type="text/javascript">
						$(document).ready(function () {
							$(".filter_btn").click(function () {
								...
								location.replace("/products_cat-remont noutbukov" + link + ".html");
							})
						})
					</script>
					...
					<div class="hidden-md-down">
						<div id="breadcrumbs" class="hidden-sm-down">
							<span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/" itemprop="url"><span
									itemprop="title">Компьютерная техника бу</span></a>&nbsp;&nbsp;>&nbsp;&nbsp;<span>Док Станции б/у</span></span>
						</div>
					</div>
					<h1 class="page_title">Док Станции б/у</h1>
					<div class="clear"></div>
					...
					<div class="products_box products">
						...
						<div class="col-md-4 col-xs-6">
							<div class="product ">
								<div class="image">
									...
									<a href="products-196.html">
										<img alt="Док станция для ноутбуков Lenovo / IBM ThinkPad Type 2504"
										     title="Док станция для ноутбуков Lenovo / IBM ThinkPad Type 2504"
										     src="images/pictures/products/20170622120007404.jpg"/>
									</a>

								</div>
								<a href="products-196.html">
									<div class="name">Док станция для ноутбуков Lenovo / IBM ThinkPad Type 2504</div>
								</a>
								<div class="line"></div>
								<div class="price">652 грн</div>
							</div>
							<div class="product product-hover">
								...
								<div class="rating_block">
									<div class="rating">
										<div class="star_box not_rated" id="star_box196">
											<div class="rate_hide">
								...
								<div class="title_dop">IBM Thinkpad R60, R61, T60, T60p, T61, Z60, Z61, R400, R500,
								                       T400, T500, W500 etc
								</div>
							</div>
						</div>
						...
						<div class="col-md-4 col-xs-6">
							<div class="product ">
								<div class="image">
									...
									<a href="products-197.html">
										<img alt="Док станция для ноутбуков Lenovo / IBM ThinkPad Type 2505"
										     title="Док станция для ноутбуков Lenovo / IBM ThinkPad Type 2505"
										     src="images/pictures/products/20170622120724896.jpg"/>
									</a>

								</div>
								<a href="products-197.html">
									<div class="name">Док станция для ноутбуков Lenovo / IBM ThinkPad Type 2505</div>
								</a>
								<div class="line"></div>
							...
							<div class="product product-hover">
								...
								<div class="rating_block">
									<div class="rating">
										<div class="star_box not_rated" id="star_box197">
											<div class="rate_hide">
												<div class="star1 star active"></div>
												<div class="star2 star active"></div>
												<div class="star3 star active"></div>
						...
						<div class="col-md-4 col-xs-6">
							<div class="product ">
								<div class="image">
									...
									<a href="products-198.html">
										<img alt="Док станция для ноутбуков Lenovo ThinkPad X6 UltraBase"
										     title="Док станция для ноутбуков Lenovo ThinkPad X6 UltraBase"
										     src="images/pictures/products/20170622121311880.jpg"/>
									</a>

								</div>
								<a href="products-198.html">
									<div class="name">Док станция для ноутбуков Lenovo ThinkPad X6 UltraBase</div>
								</a>
								<div class="line"></div>
								<div class="price">652 грн</div>
							</div>
							<div class="product product-hover">
								...
								<div class="rating_block">
									<div class="rating">
										<div class="star_box not_rated" id="star_box198">
											<div class="rate_hide">
												<div class="star1 star active"></div>
												<div class="star2 star active"></div>
												<div class="star3 star active"></div>
								...
								<div class="title_dop">IBM Thinkpad X60, X60s, X61, X61s</div>
							</div>
						</div>
						...
						<div class="col-md-4 col-xs-6">
							<div class="product ">
								<div class="image">
									...
									<a href="products-200.html">
										<img alt="Док станция для ноутбуков Dell PR03X"
										     title="Док станция для ноутбуков Dell PR03X"
										     src="images/pictures/products/20170622121453647.jpg"/>
									</a>

								</div>
								<a href="products-200.html">
									<div class="name">Док станция для ноутбуков Dell PR03X</div>
								</a>
								<div class="line"></div>
							...
							<div class="product product-hover">
								...
								<div class="rating_block">
									<div class="rating">
										<div class="star_box not_rated" id="star_box200">
											<div class="rate_hide">
												<div class="star1 star active"></div>
												<div class="star2 star active"></div>
												<div class="star3 star active"></div>
								...
								<div class="title_dop">E4200, E4300, E4310, E5400, E5410, E5420, E5500, E5510, E5520,
								                       E6220, E6320, E6400, E6400 ATG, E6400 XFR, E6410, E6410 ATG,
								                       E6420, E6420 ATG, E6500, E6510, E6520 etc
								</div>
							</div>
						</div>
						...
						<div class="col-md-4 col-xs-6">
							<div class="product ">
								<div class="image">
									...
									<a href="products-199.html">
										<img alt="Док станция для ноутбуков Lenovo ThinkPad X200 UltraBase"
										     title="Док станция для ноутбуков Lenovo ThinkPad X200 UltraBase"
										     src="images/pictures/products/20170622121808807.jpg"/>
									</a>

								</div>
								<a href="products-199.html">
									<div class="name">Док станция для ноутбуков Lenovo ThinkPad X200 UltraBase</div>
								</a>
								<div class="line"></div>
								<div class="price">1'630 грн</div>
							</div>
							<div class="product product-hover">
								<div class="image">
								...
								<div class="rating_block">
									<div class="rating">
										<div class="star_box not_rated" id="star_box199">
											<div class="rate_hide">
												<div class="star1 star active"></div>
												<div class="star2 star active"></div>
												<div class="star3 star active"></div>
								...
								<div class="title_dop">IBM Thinkpad X200, X200s, X201, X201s</div>
							</div>
						</div>
					</div>
				</div>
