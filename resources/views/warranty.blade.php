...
<head>
        ...
        <div class="page-header-content">
            ...
            <form role="form" method="get" action="{{ route('logout_out') }}" enctype="multipart/form-data">
                ...
                <div class="page-header-btn-right">
                    <button type="" clas$about_texts="btn bg-teal-400 ">Выход</button>
                </div>
            </form>
    ...
    <form style="position: relative;" method="post" action="{{ route('warranty_edit') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-content">
                                            ...
                                            <h5 class="content-group text-semibold">
                                                ...
                                                <input type="text" name="name"
                                                       value="@if(isset($warranty[0]->warranty_name )){{$warranty[0]->warranty_name }}@endif"
                                            ...
                                            <h5 class="content-group text-semibold">
                                                ...
                                                <input type="text" name="url"
                                                       value="@if(isset($warranty[0]->warranty_url )){{$warranty[0]->warranty_url }}@endif"
                                                       placeholder="Введите URL*">
                                            </h5>
                                            <h5 class="content-group text-semibold">
                                                <label>Title*</label>
                                                <input type="text" name="title"
                                                       value="@if(isset($warranty[0]->warranty_title )){{$warranty[0]->warranty_title }}@endif"
                                                       placeholder="Введите title">
                                            </h5>
                                            <h5 class="content-group text-semibold">
                                                <label style="vertical-align: top">Description*</label>
                                                <textarea placeholder="Введите description" name="description"
                                                          id="">@if(isset($warranty[0]->warranty_description)){{$warranty[0]->warranty_description}}@endif</textarea>
                                            </h5>

                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <textarea name="editor1" id="editor1">@if(isset($warranty[0]->warranty_text)){{$warranty[0]->warranty_text}}@endif</textarea>
