...
<head>
    ...
    <form style="position: relative;" method="post" action="{{ route('edit_delivery') }}" enctype="multipart/form-data">
                    ...
                    <div role="tabpanel" class="tab-pane fade in active" id="ru">
                        ...
                        <div class="panel-heading">
                            <div class="form-inline">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <textarea name="editor1" id="editor1">@if(isset($about_company[0]->delivery_text)){{$about_company[0]->delivery_text}}@endif</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
