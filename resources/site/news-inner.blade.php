		...
		<div class="second-row row hidden-md-down">
			...
			<div class="col-lg-3 col-md-3 basket" id="quick_basket">
				...
				<div class="right">
					...
					<label class='empty' style='display: none;'><a>Корзина пуста</a>
						<div class="clear"></div>
						начните ваши покупки</label>
					<label class='card11'><a href="basket.html">
						<div class='text'>Ваши покупки:</div>
					</a>
						<div class='price'><span class="quant">1</span> <span class="word">товар</span>, <span
								class="price">4300</span> грн
						</div>
					</label>
				</div>
			</div>
		...
		<div id="news_in" class="content">
			...
			<div class="like-share">
				<div class="like">
					...
					<div class="fb-like" data-href="https://evronot.com.ua/news-kak_vybrat_noutbuk.html"
