+function ($) {
    ...
    Node.prototype.initIndent = function(treeFy) {
        ...
        for (var i = 0; i < depth; i++) {
            ...
            $(indentTemplate).insertAfter(expander);
        }
    }
    ...
    Node.prototype.initExpander = function(treeFy) {
        ...
        $(expanderTemplate).prependTo(element).parent().click(function(event) {
    ...
    TreeFy.prototype.initNode = function(nodes) {
        ...
        $.each(nodes, function() {
            ...
            $row.find('.treetable-expander').parent().on("click", function(event) {
    ...
    $.fn.treeFy.defaults = {
        ...
        indentTemplate: '<span class="treetable-indent"></span><span class="treetable-indent"></span>',
